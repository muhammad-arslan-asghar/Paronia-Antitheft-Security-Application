...
public class PictureCapturingServiceImpl extends APictureCapturingService {
     ...
     */
    @Override
    public void startCapturing(final PictureCapturingListener listener, Context myContext) {
    ...
    private void openCamera(Context myContext) {
...
//        }
    ...
    private void saveImageToDisk(final byte[] bytes) {
        ...
        Log.d("Image", "saveImageToDisk: "+file);
